...
#define TASBOT_EYES_BRIGHTNESS_LEVEL_0_PERCENT 8u
#define TASBOT_EYES_BRIGHTNESS_LEVEL_1_PERCENT 50u
#define TASBOT_EYES_BRIGHTNESS_LEVEL_2_PERCENT 100u
...
#define TASBOT_EYES_GLOBAL_BRIGHTNESS_PERCENT TASBOT_EYES_BRIGHTNESS_LEVEL_0_PERCENT
...
_Static_assert(TASBOT_EYES_BRIGHTNESS_LEVEL_0_PERCENT <= 100u,
               "TASBOT_EYES_BRIGHTNESS_LEVEL_0_PERCENT must be in the range 0..100.");
_Static_assert(TASBOT_EYES_BRIGHTNESS_LEVEL_1_PERCENT <= 100u,
               "TASBOT_EYES_BRIGHTNESS_LEVEL_1_PERCENT must be in the range 0..100.");
_Static_assert(TASBOT_EYES_BRIGHTNESS_LEVEL_2_PERCENT <= 100u,
               "TASBOT_EYES_BRIGHTNESS_LEVEL_2_PERCENT must be in the range 0..100.");
