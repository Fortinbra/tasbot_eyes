...
- 2026-04-18: The current validated 256-pixel BOOTSEL image is pico_build\build\ws2812-proof\tasbot_eyes_pico.uf2 with SHA-256 D55128FDE5396663238FB4978BC3AA6D82110D1DC5FB1FB768BD1D1C2827B108 and size 100352 bytes; flashing it to BOOTSEL D:\ cleanly ejects the mass-storage device and the Plasma 2350 re-enumerates as USB Serial Device (COM10).
- 2026-04-18: On this Windows RP2350 flow, the reliable flash-verification sequence is hash match -> copy UF2 to D:\ -> confirm D:\ disappears -> watch USB serial re-enumerate; opening COM10 after enumeration still may not capture the one-shot boot banner, so missing banner text must be reported as a capture limitation unless bytes were actually seen.
